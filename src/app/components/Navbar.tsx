          ...
          <div className="hidden sm:flex sm:items-center sm:space-x-6">
            ...
            >
              <button 
                ...
                className={`flex items-center px-1 text-sm font-medium border-b-2 transition-all duration-300 ${
                  isScrolled 
                    ? 'text-gray-900 hover:text-blue-600 border-transparent hover:border-blue-600' 
                    : 'text-white hover:text-white/80 border-transparent hover:border-white'
                }`}
              >
                <span>Réseaux</span>
                <svg className={`ml-2 w-4 h-4 transform transition-transform duration-300 ${isSocialOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              ...
              <AnimatePresence>
                {isSocialOpen && (
                  <motion.div 
                    ...
                    className="absolute top-full right-0 mt-1 w-48 bg-white/90 backdrop-blur-sm rounded-lg shadow-xl py-2 ring-1 ring-black/5"
                  >
                    <motion.a 
                      ...
                      className="flex items-center px-4 py-2 text-gray-800 hover:bg-blue-50/50 transition-colors"
