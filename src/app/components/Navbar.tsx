            ...
            <div className="relative">
              ...
              <AnimatePresence>
                {isSocialOpen && (
                  ...
                  >
                    <a 
                                        href="https://www.instagram.com/nikolaz_vsn_"                  target="_blank"                  rel="noopener noreferrer"                  className="flex items-center px-4 py-2 text-gray-800 hover:bg-gray-100"
                    >
          ...
          >
            <div className="flex flex-col space-y-4">
              ...
              <div className="flex items-center space-x-4 pt-2">
                <a 
                                    href="https://www.instagram.com/nikolaz_vsn_"                  target="_blank"                  rel="noopener noreferrer"                  className={`flex items-center space-x-2 transition-colors ${                    isScrolled ? 'text-gray-600 hover:text-primary-600' : 'text-white/90 hover:text-white'                  }`}
                >
